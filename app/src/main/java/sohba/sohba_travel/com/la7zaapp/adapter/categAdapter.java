...
public class categAdapter extends RecyclerView.Adapter<categAdapter.MyViewHolder> {
    private List<categModel> itemList;
...
//            productImage = (ImageView) view.findViewById(R.id.product_image);
            ...
            setFont.changeFonts(context, (LinearLayout) view.findViewById(R.id.parent111));

        }
    }

    public categAdapter(Context c, List<categModel> moviesList) {
